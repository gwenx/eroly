...
<div class="content">
              ...
              <div class="stepOne">
	              	<table class="registTable">
		               <tr class="text-danger bg-info">
		                ...
		                <select name="courseChose" id="courseChose" style="">
		                 </select></td>
		               </tr>
		               <tr class="text-danger bg-info">
		                 <td align="right"  style="height: 50px;"><b>课程费用：&nbsp;&nbsp;</b></td>
		                 <td align="left">
		                 	<span id="subjectCost"></span>
		                 	</td>
		               </tr>
		               <tr class="text-danger bg-info"  style=" border-radius: 3px;">
		                 <td align="right"  style="height: 50px;"><b>课程定金：&nbsp;&nbsp;</b></td>
		                 <td align="left"><span id="subjectDeposit"></span></td>
		               </tr>
	               </table>
                   <span class="btn btn-info btn-lg btn-block nextBtn">下一步</span>
              </div>
               ...
               <div class="stepTwo hidden">
	               <form action="">
	               	<table style="margin-left: 140px;">
		                ...
		                <td width="190" align="left"><input type="text" name="studentRealName" size="20" value="${sessionScope.USER_INFO.userName}"/></td>
		               ...
		               <tr>
		                ...
		                <td width="170" align="left"><input type="text" id="studentTel" name="studentTel" size="20" value="${sessionScope.USER_INFO.userPhone}" onfocus="if(this.value=='输入联系方式') this.value='';" onblur="if(this.value=='') this.value='输入联系方式';else chkTel(this.value)" value="输入联系方式"  /></td>
		                <td align="left" nowrap="nowrap"><span id="tel_span">请填写常用手机号</span></td>
		               </tr>
		               <tr>
		                 <td align="right"  style="width: 40%;height: 50px;">联系地址&nbsp;&nbsp;</td>
		                 <td width="190" align="left"><input type="text" name="studentAddr" value="${sessionScope.student.studentAddr}" size="20" onfocus="if(this.value=='输入详细地址') this.value='';" onblur="if(this.value=='') this.value='输入详细地址'; " value="输入详细地址" /></td>
		                 <td align="left" nowrap="nowrap"><span>请填写您的详细地址</span></td>
		               </tr>
		               <tr>
		                 <td height="50" align="right"  style="width: 40%;height: 50px;"><input type="submit" value="报 名" onclick="javascript:return check()" style="margin-right:5px;;width:80px;height:30px;color:#FFF;border:0;background-color:#DE3237;"></td>
   ...
   <div class="clear"></div><!--清除浮动-->
	...
	<script type="text/javascript" src="resources/js/signUp/signUp2.js"></script>
</body>
</html>
